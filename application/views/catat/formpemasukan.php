                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">PEMASUKAN</h3>
                                        </div>
                                        <hr>
                                        <div class="sukses" data-sukses="<?= $this->session->flashdata('sukses'); ?>"></div>
                                            <?php if ($this->session->flashdata('sukses')) : ?>
                                            <?php endif; ?>
                                        <form action="<?= base_url('catatuang/inputPemasukan'); ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="asal" class="control-label mb-1">Asal pemasukan</label>
                                                <input id="asal" name="asal" type="text" class="form-control" required>
                                            </div>
                                                    <div class="form-group">
                                                        <label for="tanggal" class="control-label mb-1">Tanggal pemasukan</label>
